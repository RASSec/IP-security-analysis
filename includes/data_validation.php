...
$results = browse($filter, $export); //list data
$getip = gettopip(); //add getiptop10
$getipdate = gettopipdate(); //add getiptop10date
$getipweek = gettopipweek(); //add getiptop10week
$getipmonth = gettopipmonth(); //add getiptop10month
$getrule = getrule(); // show rule